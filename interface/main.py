...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.levels_of_abstraction_option_menu.grid(row=4, column=0, padx=20, pady=(10, 20))
        ...
        self.open_file_button = customtkinter.CTkButton(self.sidebar_frame, text="Open file", bg_color="red",
